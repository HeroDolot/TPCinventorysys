...
$sql = "SELECT * FROM carousel WHERE foldername='NewArrival'";
 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-danger">New Arrival</h1>
            <div class="row pl-5">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item <?php echo $i == 0 ? 'active' : ''; ?>">
      <img src="<?='../assets/images/NewArrival'."/".$row['names'];?>" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <?php
         echo "<h5 class='text-dark'>" . $row['label'] . " " . "</h5>";
         echo "<p class='text-dark'>" . $row['descriptions'] . " " . "</p>";
        ?>
      </div>
    </div>
    <?php
