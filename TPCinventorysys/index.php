<?php
  ...
  }else if(isset($_SESSION['adminTPC'])=='abc123'){
...
<div class="login-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./pages/landing-page-unlog.php" class="h1"><b>TPC</b><span class="color-surplus">Surplus</a>
    </div>
    <div class="card-body">
      ...
      <p class="mb-1">
        <a href="./pages/fpassword.php">Forgot Password</a>
      </p>
      <p class="mb-0">
        <a href="./pages/reg.php" class="text-center">Register</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
